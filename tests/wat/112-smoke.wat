(module
  ...
  (func $main (export "main") (result i32)
    ...
    (i32.store align=4 (local.get $a) (i32.const -17))
    (i32.store align=4 (i32.add (local.get $a) (i32.const 4)) (i32.const 11))
    (local.set $res (call $add (i32.load align=4 (local.get $a)) (i32.load align=4 (i32.add (local.get $a) (i32.const 4)))))
