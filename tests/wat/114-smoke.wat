(module
  ...
  (func $set_value_of_a_to_57 (param $a i32) (result i32)
    (i64.store align=8 (local.get $a) (i64.const 57))
    (i32.const -1))
  (func $main (export "main") (result i32)
    ...
    (i64.store align=8 (local.get $a) (i64.const 0))
    (drop (call $set_value_of_a_to_57 (local.get $a)))
    (i64.store align=8 (global.get $@stack) (i64.load align=8 (local.get $a)))
